...
### Ρόλοι Χρηστών ###
Η πλατφόρμα έχει τους εξής ρόλους χρηστών: πάροχος, γονέας, διαχειριστής και ανώνυμος χρήστης:
...
### Σύστημα πληρωμών - Ηλεκτρονικό Πορτοφόλι ###
...
1. Θα υπάρχουν δυο διαφορετικές φόρμες εγγραφής μία για τον γονέα και μία για τον πάροχο.
Για το Design των ιστοσελίδων χρησιμοποιήθηκαν οι γλώσσες html και css καθώς και javascript.
Επίσης, έγινε χρήση των εξής βιβλιοθηκών:

Bootstrap: Mε τη χρήση της συγκεκριμένης βιβλιοθήκης επιτυγχάνουμε responsive Design.
...
2. Δυνατότητα υποστήριξης  Online υπηρεσίας χαρτών με τις τοποθεσίες των δραστηριοτήτων.παρουσίασης.Η παρουσίαση των τοποθεσιών  στον χάρτη,επιτυγχάνεται μέσω της υπηρεσία google maps API.
...
![wireframe1](http://i65.tinypic.com/rk3fyb.jpg)


![wireframe2](http://i63.tinypic.com/20hoykn.jpg)
