        ...
        <ul class="topbar-btns">
          <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <a class="dropdown-item no-underline" href="#home"><i class="pe-7s-user pe-lg"></i> Λογαριασμός</a>
              <a class="dropdown-item no-underline" href="#"><i class="pe-7s-wallet pe-lg"></i> Ιστορικό εκδηλώσεων</a>
	      <a class="dropdown-item no-underline" href="#"><i class="pe-7s-tools pe-lg"></i> Επεξεργασία Λογαριασμού</a>
	      <a class="dropdown-item no-underline" href="#"><i class="pe-7s-gleam pe-lg"></i>  Διαφήμιση</a>
...
<!--        <div class="center-h"> -->
		...
		<ins>
            <h1 style="text-align:center"> Προσωπικά Στοιχεία Λογαριασμού</h1>
		</ins>
...
<div style="margin: 20px 0px 20px 0px">
		<table class="beta" style="width:100%" id="t01"><b>
		  <tr>
		    <th>Εκδήλωση 1<sup>η</sup></th>
		    <th>Πωλήσεις εισιτηρίων</th>
		  </tr>
		  <tr>
		    <td>random</td>
		    <td>random</td>
...
<div>
		<a href="#" class="button" margin-top: 100px;>Δημιουργία Νέας Εκδήλωσης</a>
</div>
</div>
</div>
